...
### 빈칸 살펴보기  
(1) 첫번째 빈칸
- `1~N` 사이의 숫자 값이 들어갈 수 있습니다.  
- 직접 숫자를 입력하거나, 숫자 `값 블록`을 넣거나, 숫자를 나타내는 변수 블록을 넣을 수 있습니다.  
- 여기에 적힌 숫자만큼 안쪽 코드가 반복됩니다.    
- 예를 들어 여기에 `3`을 입력하면, 안쪽 코드를 3번 반복한 후에 다음 블록을 실행합니다.  

### 언제, 어떻게 사용할까요?  
코드를 여러번 반복하고 싶을 때 이 블록을 사용할 수 있습니다. 입력 상자에 입력한 숫자만큼 블록 안쪽 코드를 반복합니다.  
